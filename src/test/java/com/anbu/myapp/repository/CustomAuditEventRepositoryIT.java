package com.anbu.myapp.repository;

import com.anbu.myapp.SimpleJhipAppWithOAuth2App;
import com.anbu.myapp.config.Constants;
import com.anbu.myapp.config.audit.AuditEventConverter;
import com.anbu.myapp.domain.PersistentAuditEvent;
...
import static com.anbu.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
